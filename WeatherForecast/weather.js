...
$().ready(function() {
    ...
    $("#search").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "GET",
                url: "http://weatherforecast-env.us-east-1.elasticbeanstalk.com/",
...
$.fn.nexttab = function(data) {
    var image = ['clear.png', 'clear_night.png', 'rain.png', 'snow.png', 'sleet.png', 'wind.png', 'fog.png', 'cloudy.png', 'cloud_day.png', 'cloud_night.png'];
